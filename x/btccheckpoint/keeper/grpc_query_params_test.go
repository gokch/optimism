...
func FuzzParamsQuery(f *testing.F) {
	f.Add(uint32(11111), uint32(3232), int64(23))
	f.Add(uint32(22222), uint32(444), int64(330))
	f.Add(uint32(22222), uint32(12333), int64(101))

	f.Fuzz(func(t *testing.T, btcConfirmationDepth uint32, checkpointFinalizationTimeout uint32, seed int64) {
		...
		if btcConfirmationDepth == 0 {
			...
			params.BtcConfirmationDepth = uint32(r.Int31())
		}
		...
		if checkpointFinalizationTimeout == 0 {
			// validation should not pass with zero EpochInterval
			require.Error(t, params.Validate())
			params.CheckpointFinalizationTimeout = uint32(r.Int31())
		}
